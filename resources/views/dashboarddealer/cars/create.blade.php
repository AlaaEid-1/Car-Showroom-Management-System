<x-layout.dashboard title="Add New Listing | Alaa Motors" header="Create New Listing">
    ...
    <div class="max-w-3xl mx-auto bg-white border border-slate-200 rounded-3xl p-8 shadow-sm">
        <div class="mb-8 border-b border-slate-100 pb-6 flex items-center justify-between">
            <div>
                ...
                <p class="text-xs text-slate-500 mt-1">Please fill in the specifications and upload vehicle photos below.</p>
            </div>
        ...
        <form action="{{ route('dashboarddealer.cars.store') }}" 
              method="POST" 
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <!-- Year -->
                <div>
                    <x-forms.input name="year" label="Production Year" placeholder="e.g. 2021" type="number" required :value="$car->year ?: date('Y')" />
                </div>
            ...
            <div class="bg-slate-50 border border-slate-200 rounded-2xl p-6 space-y-4" x-data="{
                ...
                generateAI() {
                    ...
                    fetch('{{ route('dashboarddealer.ai.generate') }}', {
                        method: 'POST',
                        headers: {
                ...
                <p class="text-xs text-slate-500">
                    Click the button above to generate a premium title, description, and highlights based on your current form inputs.
                </p>
                ...
                <div x-show="result" class="border border-luxury-gold/30 bg-white rounded-2xl p-5 space-y-4 shadow-sm" style="display: none;">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="space-y-1">
                            <label class="block text-[10px] font-bold text-slate-400 uppercase">Suggested Description</label>
            ...
            <div class="space-y-2" x-data="{ 
                ...
                <x-forms.label value="Vehicle Photography" />
                ...
                <div x-show="filesList.length > 0" class="bg-slate-50 border border-slate-200/60 rounded-xl p-4 space-y-2 mt-4" style="display: none;">
                    <span class="text-[10px] font-bold text-slate-400 uppercase block tracking-wider">Selected Files Queue:</span>
